...
class KZVanillaModeService : public KZModeService
{
	...
	f32 distanceTiers[JUMPTYPE_COUNT - 3][DISTANCETIER_COUNT] = {
		...
		{150.0f, 230.0f, 233.0f, 238.0f, 240.0f, 242.0f}, // BH
		{150.0f, 232.0f, 237.0f, 242.0f, 245.0f, 248.0f}, // MBH
		{150.0f, 230.0f, 235.0f, 240.0f, 244.0f, 246.0f}, // WJ
		{50.0f, 80.0f, 90.0f, 100.0f, 105.0f, 108.0f},    // LAJ
		{215.0f, 250.0f, 253.0f, 258.0f, 261.0f, 263.0f}, // LAH
