			  ...
			  FCVAR_NONE)
{
	...
	// {
	// 	KZ_LOG_INFO(LogChannel::General, "[KZ::Anticheat] Cannot unban players while connected to the global service.\n");
	// 	return;
	// }

	if (args.ArgC() != 2)
	{
		KZ_LOG_INFO(LogChannel::General, "[KZ::Anticheat] Usage: kz_unban <SteamID64>\n");
		return;
	}
